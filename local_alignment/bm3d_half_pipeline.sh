...
bash unblur.sh $5_bm3d_$1_$2_$3_half $4 > $5_bm3d_shifts_$1_$2_$3_$4_half_raw.txt
echo 'formating frame shifts'
python format_summovie_shifts.py $5_bm3d_shifts_$1_$2_$3_$4_half_raw.txt 1.5
echo 'aligning and averaging the frames'
bash summovie.sh $5.mrc $5_bm3d_averaged_$1_$2_$3_$4_half.mrc $5_bm3d_shifts_$1_$2_$3_$4_half_summovie.txt $5_bm3d_frc_$1_$2_$3_$4_half.txt > /dev/null
