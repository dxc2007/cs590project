...
then
 ...
 python bm3d_filtering.py $5_ub_stacked_$4.mrc $5_ubbm3d_$1_$2_$3_$4_half.mrc $1 $2 $3
fi
...
python format_summovie_shifts.py $5_ubbm3d_shifts_$1_$2_$3_$4_half_raw.txt 1.5 
